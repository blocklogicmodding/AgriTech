...
public class AgritechPlanterBlockEntityRendered implements BlockEntityRenderer<AgritechPlanterBlockEntity> {

    public AgritechPlanterBlockEntityRendered(BlockEntityRendererProvider.Context context) {
